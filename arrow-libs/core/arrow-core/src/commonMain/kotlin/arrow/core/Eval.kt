...
fun <A, B, C, D, E, F> Eval<A>.zip(
  ...
  zip(b, c, d, e, Eval.unit, Eval.unit, Eval.unit, Eval.unit, Eval.unit) { aa, bb, cc, dd, ee, _, _, _, _, _ ->
    map(
      aa,
      bb,
      cc,
...
fun <A, B, C, D, E, F, G> Eval<A>.zip(
  ...
  zip(b, c, d, e, f, Eval.unit, Eval.unit, Eval.unit, Eval.unit) { aa, bb, cc, dd, ee, ff, _, _, _, _ ->
    map(
      aa,
      bb,
      cc,
...
fun <A, B, C, D, E, F, G, H> Eval<A>.zip(
  ...
  zip(b, c, d, e, f, g, Eval.unit, Eval.unit, Eval.unit) { aa, bb, cc, dd, ee, ff, gg, _, _, _ ->
    map(
      aa,
      bb,
      cc,
...
fun <A, B, C, D, E, F, G, H, I> Eval<A>.zip(
  ...
  zip(b, c, d, e, f, g, h, Eval.unit, Eval.unit) { aa, bb, cc, dd, ee, ff, gg, hh, _, _ ->
    map(
      aa,
      bb,
      cc,
...
fun <A, B, C, D, E, F, G, H, I, J> Eval<A>.zip(
  ...
  zip(b, c, d, e, f, g, h, i, Eval.unit) { aa, bb, cc, dd, ee, ff, gg, hh, ii, _ ->
    map(
      aa,
      bb,
      cc,
